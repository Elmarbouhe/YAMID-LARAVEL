<x-action-section>
    ...
    <x-slot name="content">
        ...
        <x-dialog-modal wire:model="confirmingUserDeletion">
            ...
            <x-slot name="content">
                {{ __('Veuillez confirmer que vous souhaitez supprimer votre compte. Une fois votre compte supprimé, toutes ses ressources et données seront définitivement supprimées. Veuillez saisir votre mot de passe pour confirmer que vous souhaitez supprimer définitivement votre compte.') }}
